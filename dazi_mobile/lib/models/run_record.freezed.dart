...
abstract class $RunRecordCopyWith<$Res> {
  ...
  @useResult
  $Res call({String at, String action, bool ok, String? message});
}
...
class _$RunRecordImpl implements _RunRecord {
  const _$RunRecordImpl(
      {required this.at, required this.action, required this.ok, this.message});
  ...
  @override
  String toString() {
    return 'RunRecord(at: $at, action: $action, ok: $ok, message: $message)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, at, action, ok, message);
...
abstract class _RunRecord implements RunRecord {
  const factory _RunRecord(
      ...
      final String? message}) = _$RunRecordImpl;
